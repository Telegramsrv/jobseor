	...
	public function onDisplay()
	{
		...
		$display->setColumnFilters(
			[
			    ...
			    \AdminColumnFilter::select()->setPlaceholder('Название вакансии')->setModel(new Vacancy())->setDisplay('title'),
			    \AdminColumnFilter::select()->setPlaceholder('Название VIP тарифа')->setModel(new VipVacancySettings())->setDisplay('name'),
