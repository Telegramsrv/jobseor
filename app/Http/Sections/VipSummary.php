	...
	public function onDisplay()
	{
		...
		$display->setColumnFilters(
			[
				...
				\AdminColumnFilter::select()->setPlaceholder('Название резюме')->setModel(new Summary())->setDisplay(
					'title'
				),
				\AdminColumnFilter::select()->setPlaceholder('Название VIP тарифа')->setModel(
					new VipSummarySettings()
				)->setDisplay('name'),
	...
	public function onEdit($id)
	{
		return \AdminForm::panel()->addBody(
			[
				...
				\AdminFormElement::select('settings_id', 'VIP Тариф', VipSummarySettings::class)->setDisplay(
					'name'
				)->required(),
